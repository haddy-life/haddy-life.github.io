// inspired by, and adapted from Francesco Michelini and Paulina Hetman
...
class World {
    ...
    addSpiral() {
        ...
        const colorChoices = ["orange", "gray", "wheat", "black"];
    ...
    addOctahedron({ color = "orange", scale, position = [0, 0, 0] }) {
    ...
    addOctahedrons() {
        ...
        this.addOctahedron({ color: "#F4773A", scale: [1, 1.4, 1] });
        this.addOctahedron({
            color: "#F4773A",
            position: [0, 0.85, 0],
            scale: [0.5, 0.7, 0.5]
